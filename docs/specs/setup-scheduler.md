...
1. **設定自動喚醒（⚠️ Bug Fix #6）**：
   - 先嘗試：`sudo pmset repeat wakeorpoweron MTWRFSU 09:55:00`
...
2. **安裝 launchd**：
   ...
   - StartCalendarInterval：10:00（每日早班）
