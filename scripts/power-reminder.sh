#!/bin/bash
# power-reminder.sh — 09:50 電源提醒（S-PWR P-1）
# 由 launchd `com.ainewshub.power-reminder` 每日 09:50 觸發。
...
osascript -e 'display notification "10:00 擷取即將開始，請接電源" with title "AI News Hub"' 2>/dev/null || true
