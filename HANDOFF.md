...
| 2 | 拆成 4 個 session（見 §2）：S2-A canaries + metrics；S2-B run-agents 接線；S2-C search-reviewer scaffold + input；S2-D `newshub_search_reviewer.py` + 08b 接線 | **S2-A 已 commit（折進 `e0f71a4`）；S2-B 已 commit `ce88f38`；S2-C 的 2-5 已在磁碟；S2-D 未動工** | S2-A `e0f71a4`（原 `8a2d97a` 懸空）；S2-B `ce88f38` |
